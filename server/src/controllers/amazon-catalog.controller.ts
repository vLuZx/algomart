 ...
 */
export async function searchByBarcode(req: Request, res: Response, next: NextFunction) {
  try {
 ...
 */
export async function searchByUpc(req: Request, res: Response, next: NextFunction) {
  try {
 ...
 */
export async function searchByEan(req: Request, res: Response, next: NextFunction) {
  try {
 ...
 */
export async function getByAsin(req: Request, res: Response, next: NextFunction) {
  try {
 ...
 */
export async function getSalesRank(req: Request, res: Response, next: NextFunction) {
  try {
    const { asin } = req.params;
